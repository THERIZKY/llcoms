          ...
          <div className="grid lg:grid-cols-[minmax(0,1.45fr)_360px]">
            <div className="relative min-h-[320px] overflow-hidden px-6 py-8 sm:px-8 sm:py-10">
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 bg-[linear-gradient(115deg,rgba(248,250,255,0.3)_0%,rgba(243,244,255,0.68)_35%,rgba(248,250,255,0.94)_100%)] dark:bg-[linear-gradient(115deg,rgba(5,7,11,0.35)_0%,rgba(5,7,11,0.78)_45%,rgba(5,7,11,0.98)_100%)]" />
            ...
            <div className="relative min-h-[240px] border-t border-border/70 lg:border-t-0 lg:border-l">
              ...
              <div className="absolute inset-x-6 bottom-6 rounded-[28px] border border-border/70 bg-card/76 p-4 backdrop-blur-md">
                ...
                <p className="mt-2 text-lg font-semibold text-foreground">{concert.title}</p>
                <p className="mt-1 text-sm text-muted-foreground">{groupLabel}</p>
              </div>
            </div>
          </div>
        </section>
