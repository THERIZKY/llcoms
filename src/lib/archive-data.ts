...
export const groups: Group[] = [
  ...
  },
  {
    ...
    name: "Aqours",
    slug: "aqours",
    thumbnail: "from-sky-500 to-cyan-400",
  ...
  },
  {
    ...
    name: "Nijigasaki",
    slug: "nijigasaki",
    thumbnail: "from-yellow-500 to-lime-400",
...
export const concerts: Concert[] = [
  ...
  },
  {
    ...
    description: "Colorful solo stages and crowd call-and-response moments.",
    isCrossGeneration: false,
  },
  {
    id: "con_liella_4th",
  ...
  },
  {
    ...
    groupSlug: "cross-generation",
    thumbnail: "from-emerald-500 to-sky-500",
    eventYear: 2024,
...
export const videos: Video[] = [
  {
    id: "vid_muse_final_day1",
    concertSlug: "muse-final-lovelive",
    title: "Day 1 Full Concert",
    driveUrl: "https://drive.google.com/file/d/DRIVE_FILE_ID_1/preview",
    order: 1,
...
export const markers: Marker[] = [
  { id: "m_1", videoId: "vid_unit_live_main", timestamp: 0, label: "Opening" },
  { id: "m_2", videoId: "vid_unit_live_main", timestamp: 312, label: "Song 1" },
  { id: "m_3", videoId: "vid_unit_live_main", timestamp: 645, label: "Song 2" },
];
